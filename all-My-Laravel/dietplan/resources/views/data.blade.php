              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    ...
                    <form class="form-group" action="{{route('datas.index')}}" name="bmicalc" id="bmicalc" method="post" enctype="multipart/form-data">@csrf
                                <div class="modal-body">
                                  <div class="container-fluid">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-md-4 my-1"><input type="text" name="myage"  required="required" class="form-control"></div>
                                    </div>
                                    <div class="row">
                                      <div class="col-md-4 my-1">Height</div>
                                      <div class="col-md-4 my-1"><input type="number" name="fheight" required="require" placeholder="Feet" class="form-control" min=4 max=7 ><input type="number" required="required" name="iheight" min="0" max="11" placeholder="inches" class="form-control"></div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 text-md-right">
                                        <input type="submit" name="givems" id="givems" class="btn btn-primary" value="Calculate Your Result"/>                                    
                                    </div>
