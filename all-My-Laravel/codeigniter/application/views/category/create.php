...
<!-- 
	  				...
	  				<div class="form-group row">
	    				...
	    				<div class="col-sm-10">
	      					<template class="form-control" id="summernote">
	  				...
	  				<div class="form-group row">
	    				<label for="name" class="col-sm-2 col-form-label"> Facilily </label>
	    				<div class="col-sm-10">
	      					<input type="text" class="form-control" id="name" placeholder="Facilily Type" name="categoryname" data-role="tagsinput">
	      					<span class="text-danger"><?php echo form_error('categoryname');?></span>
	    				</div>
	  				</div>
 -->
