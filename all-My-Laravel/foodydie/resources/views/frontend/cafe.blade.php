      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-4">
            <h1 class="mb-3 bread">Cafe</h1>
             <p class="breadcrumbs"><span class="mr-2"><a href="/#home-section">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>CAFE <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
                    ...
                    <div class="project">
                      ...
                      <div class="text">
                       ...
                       <!--  <span>3 nights</span> -->
                        <h3 class="my-1">
                        <label>Name:</label>  
                        <a href="hotel-single.html">{{$shop->name}}</a></h3>
                        <h3 class="my-1">
                        ...
                        <h3 class="my-1">
                        <label style="font-size:bold;color:green;">
                        <a href="hotel-single.html" style="font-size:bold;color:green;">{{$shop->open}}</a></label>
                        <label style="font-size:bold;color:red;">
                        <a href="hotel-single.html" style="font-size:bold;color:red;">{{$shop->close}}</a></label>
                        <h3 class="my-1">
