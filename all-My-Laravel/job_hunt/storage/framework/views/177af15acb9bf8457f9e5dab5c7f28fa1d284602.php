<?php /* /home/maungmyint/Code/web/job_hunt/resources/views/employeeinfo.blade.php */ ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('employeeinfo.index')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>                  
