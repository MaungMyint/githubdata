    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('seekerinfo.index') }}" enctype="multipart/form-data">
                        @csrf                
                        ...
                        <div class="form-group row">
                            <label for="cvform" class="col-md-4 col-form-label text-md-right">{{ __('CV Form') }}</label>

                            <div class="col-md-6">
                                <input id="cvform" type="file" class="form-control{{ $errors->has('cvform') ? ' is-invalid' : '' }}" name="cvform" required>

                                @if ($errors->has('cvform'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('cvform') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
